...
ALTO = int(input("Dime la altura de la cuadricula: "))  # Alto de la cuadrícula

VIVO = input("Dime un carácter para usar como figura de una celda viva: ")  # Carácter para la celda viva
if len(VIVO) > 1:
    raise Exception("La figura sólo puede ser un único carácter")
